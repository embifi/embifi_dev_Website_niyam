...
function Moreinfo({ reference, contact }) {
  ...
  return (
    <section id="more-info" ref={whyUs}>
        ...
        <Container>
          <div>
            <Row>
              ...
              we build structured credit products
                {/* Save the build time, team’s bandwidth and yet build your own
                credit product */}
              </Col>
              <Col md={6} className="content-center">
                <img
              ...
              <Row>
                ...
                <Col lg={9} className="help-div">
                  <span className="get-head">
                    {/* We help your business customers access credit */}
                    We help your customers access credit
